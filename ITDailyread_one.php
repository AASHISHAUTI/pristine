...
<table class='table table-hover table-responsive table-bordered'>
    ...
    <tr>
        ...
        <td><?php echo htmlspecialchars($Follow_UP_Taken, ENT_QUOTES);  ?></td>
    </tr>
    
    <tr>
        <td>Shiksha</td>
        <td><?php echo htmlspecialchars($Shiksha, ENT_QUOTES);  ?></td>
    </tr>
    <tr>
        <td>Sulekha</td>
        <td><?php echo htmlspecialchars($Sulekha, ENT_QUOTES);  ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td><?php echo htmlspecialchars($Rizwan_Sir_Reference_FB, ENT_QUOTES);  ?></td>
    </tr>
    <tr>
        <td>Leads Forwarded to Other Branch</td>
        <td><?php echo htmlspecialchars($Leads_Forwarded_to_Other_Branch, ENT_QUOTES);  ?></td>
    </tr>

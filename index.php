...
<head>
  ...
  <title>Pristine Infosolutions-Vashi</title>
  <link rel="icon" href="pristine.png">
  <!-- Bootstrap core CSS-->
    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
          ...
          <center>
          <button class="btn btn-primary btn" type="submit" name="login" value="login">Login</button>
      <button class="btn btn-primary btn" type="reset" name="reset">Reset</button></center>
        <br><br><center><label><a href="http://www.pristineinfo.com/"><h6>Developed By Pristine Infosolutions,Vashi</h6></a></label>  
       </center></form>

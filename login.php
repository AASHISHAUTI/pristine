    ...
    <div class="card card-login mx-auto mt-5">
      ...
      <div class="card-body">
        ...
        <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
          ...
          <center><button class="btn btn-primary btn" type="reset" name="reset">Reset</button>
          <button class="btn btn-primary btn" type="submit" name="login" value="login">Login</button></center>

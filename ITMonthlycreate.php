...
<body>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <h1>Add Entry IT Counsellor-Monthly</h1>
        </div>
...
if($_POST){
    ...
    try{
        ...
        // insert query
        $query = "INSERT INTO IT_Counseller_Monthly SET Name=:Name, Target=:Target,Meetings_Topics=:Meetings_Topics,Conclusion=:Conclusion, Result=:Result, created=:created";
    ...
    <table class='table table-hover table-responsive table-bordered'>
        <tr>
         ...
         <tr>
            ...
            <td><input type='text' name='Meetings_Topics' class='form-control' placeholder="Meetings Topics" required/></td>
        </tr>
         <tr>
            <td>Conclusion</td>
